...
<title>Planta Productora de Vacunas (Misión) Gerencia Sectorial de Producción</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
    <h1 class="contenedor_0">MISIÓN DE LA PLANTA PRODUCTORA DE VACUNAS</h1>
    <img class="columns2" src="imagenes/img_gp/ppv.png" alt="Imagen Gerencia de Producción" title="Imagen Gerencia de Producción">
    <div class="sections2">
    	<p class="columns">Producir antígenos multifuncional, para formulación, mezcla, llenado y embalaje de vacunas y su control de producción de biomodelos experimentales con los estándares internacionales de calidad y criterios de Buenas Prácticas de Manufactura (BPM), </p>
    	<p class="columns">las cuales permitirán al Instituto Nacional de Higiene "Rafael Rangel" obtener el Certificado como Laboratorio Productor de Vacuna DPT que otorga la Organización Mundial de la salud y la Oficina Sanitaria Panamericana (OMS/OPS).</p>
    </div>
</div>
<!-- InstanceEndEditable -->
<div class="derecha">
