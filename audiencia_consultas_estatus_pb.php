...
<title>Gerencia Sectorial de Registro y Control - Productos Biológicos (Audiencias Consultas y Estatus)</title>
<!-- InstanceEndEditable -->
	...
	<div id="page-wrap">
        ...
        <div id="example-one">
        	...
        	<!-- 1 Audiencias -->
                ...
                <p class="boton_global">Las solicitudes de audiencia relacionadas con productos biológicos  deberán ser solicitadas por el Farmacéutico Patrocinante a través del correo electrónico  <strong>divcnpb@inhrr.gob.ve</strong> indicando:</p>
                	<ul class="vinetas">
        	...
        	<!-- 2 Solicitud de Estatus -->	 
        		 <ul id="dos" class="hide">
                 <h3 class="contenedor_1">Solicitud de Estatus</h3>
                <p class="boton_global">Las solicitudes de estatus de una solicitud correspondiente a  especialidades farmacéuticas  deberán ser solicitadas por el Farmacéutico Patrocinante a través del correo electrónico <strong>divcnpb@inhrr.gob.ve</strong> indicando:</p>
                	<ul class="vinetas">
			...
			<!-- 3 Consultas -->        		 
                ...
                <p class="boton_global">Las consultas relacionadas con los procedimientos de evaluación de especialidades farmacéuticas o materiales médicos  deberán ser solicitadas a través del correo electrónico <strong>divcnpb@inhrr.gob.ve</strong></p>
                 </ul> 
        		 </ul>
