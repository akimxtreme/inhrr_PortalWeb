...
<title>Gerencia Sectorial de Producción - División de Control Interno de Calidad de Biológicos (Asesorías)</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
<h1 class="contenedor_0">ASESORIAS DE LA DIVISIÓN DE CONTROL INTERNO DE CALIDAD DE BIOLÓGICOS</h1>
<ul class="vinetas">
<li class="vinetas">Apoyar los planes de capacitación técnico-científico, adiestramiento del personal profesional, técnico y administrativo del Instituto en el área de nuestra competencia.</li>
<li class="vinetas">Asesorar técnica y científicamente a unidades internas, organismos e instituciones nacionales e internacionales en las actividades inherentes a la División.</li>
</ul>
</div>
<!-- InstanceEndEditable -->
<div class="derecha">
