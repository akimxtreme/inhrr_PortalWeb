...
<form class="cv" method="post" action="ce_actualizar.php" onsubmit="return validar_ce(this);">
...
<input class="cv" type="text" name="ce_cedula" readonly="readonly" value="<?php echo $ce_cedula;?>" id="ce_cedula"  />
</span>
...
<input class="cv" type="text" name="cod_carnet" value="<?php echo $cod_carnet;?>" />
</span>
<h2 class="cv">Control de Expedientes</h2>
<span class="cv">
<label class="cv">Copia de la Cédula</label>
<input class="cv" type="text" onkeypress="return soloLetras(event);" id="st_cedula" name="st_cedula" maxlength="2" value="<?php echo $st_cedula;?>" />
<p class="obligatorio" id="obligatorio_st_cedula">Ingrese si o no</p>
</span>

<span class="cv">
<label class="cv">Fotografía</label>
<input class="cv" type="text"  onkeypress="return soloLetras(event);" id="st_foto" name="st_foto" maxlength="2" value="<?php echo $st_foto;?>" />
<p class="obligatorio" id="obligatorio_st_foto">Ingrese si o no</p>
</span>

<span class="cv">
<label class="cv">Sintesis Curricular</label>
<input class="cv" type="text"  onkeypress="return soloLetras(event);" id="st_curriculum" name="st_curriculum" maxlength="2"  value="<?php echo $st_curriculum;?>" />
<p class="obligatorio" id="obligatorio_st_curriculum">Ingrese si o no</p>
</span>

<span class="cv">
<label class="cv">Partida de Nacimiento</label>
<input class="cv" type="text"  onkeypress="return soloLetras(event);" id="st_partida_nacimiento" name="st_partida_nacimiento" maxlength="2"   value="<?php echo $st_partida_nacimiento;?>" />
<p class="obligatorio" id="obligatorio_st_partida_nacimiento">Ingrese si o no</p>
</span>

<span class="cv">
<label class="cv">Copia - Título(s)</label>
<input class="cv" type="text"  onkeypress="return soloLetras(event);" id="st_titulo" name="st_titulo" maxlength="2"  value="<?php echo $st_titulo;?>" />
...
echo '<input class="cv" type="text" onkeypress=" return soloNumeros(event);" id="st_titulo_cantidad" name="st_titulo_cantidad" maxlength="2" value="';
...
<input class="cv" type="text"  onkeypress="return soloLetras(event);" maxlength="2" id="st_certificado" name="st_certificado"  value="<?php echo $st_certificado;?>" />
...
echo '<input class="cv" type="text"   onkeypress=" return soloNumeros(event);" id="st_certificado_cantidad" name="st_certificado_cantidad" maxlength="2" value="';
...
<input class="cv" type="text"  onkeypress="return soloLetras(event);" maxlength="2" id="st_reposo" name="st_reposo" value="<?php echo $st_reposo;?>" />
...
echo '<input class="cv" type="text"   onkeypress=" return soloNumeros(event);" id="st_reposo_cantidad" name="st_reposo_cantidad" maxlength="2" value="';
...
<input class="cv" type="text"   onkeypress="return soloLetras(event);" maxlength="2" id="st_amonestaciones" name="st_amonestaciones" value="<?php echo $st_amonestaciones;?>" />
...
echo '<input class="cv" type="text"   onkeypress=" return soloNumeros(event);" maxlength="2" id="st_amonestaciones_cantidad" name="st_amonestaciones_cantidad" value="';
...
<input class="cv" type="text"  onkeypress="return soloLetras(event);" maxlength="2" id="st_plan_servicio" name="st_plan_servicio" value="<?php echo $st_plan_servicio;?>" />
