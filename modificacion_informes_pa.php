...
<title>Gerencia Sectorial de Registro y Control - Productos Alimenticios (Modificación de informes)</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
<h1 class="contenedor_0">MODIFICACION DE INFORMES</h1>

<p class="boton_global"> Para la solicitud de modificación de Informe de Ensayo, en cuanto a: nombre, marca y/o fabricante, debe consignarse un documento autenticado suscrito por los representantes legales involucrados, para su debida tramitación.</p>
</div>
