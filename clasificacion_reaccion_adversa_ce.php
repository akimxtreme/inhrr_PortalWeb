...
<title>Gerencia Sectorial de Registro y Control - Centro Nacional de Vigilancia Farmacológica - (Clasificación de las Reacciones Adversas a Medicamentos)</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
<h1 class="contenedor_0">CLASIFICACIÓN DE LAS REACCIONES ADVERSAS A MEDICAMENTOS:</h1>
<img class="" src="imagenes/img_rc/clasificacion_reaccion_adversa_ce.png" alt="CLASIFICACIÓN DE LAS REACCIONES ADVERSAS A MEDICAMENTOS" title="CLASIFICACIÓN DE LAS REACCIONES ADVERSAS A MEDICAMENTOS"/>
</div>
