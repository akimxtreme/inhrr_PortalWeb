...
<title>Gerencia Sectorial de Registro y Control - Centro Nacional de Vigilancia Farmacológica - (Proceso de Reacciones Adversas a Medicamentos hacia Uppsala Monitoring Centre. OMS - UMC)</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
<h1 class="contenedor_0">PROCESO DE NOTIFICACIÓN DE REACCIONES ADVERSAS A MEDICAMENTOS HACIA UPPSALA MONITORING CENTRE. OMS - UMC.</h1>
<img class="" src="imagenes/img_rc/proceso_notificacion_reaccion_adversa_ce.png" alt="PROCESO DE NOTIFICACIÓN DE REACCIONES ADVERSAS A MEDICAMENTOS HACIA UPPSALA MONITORING CENTRE. OMS - UMC" title="PROCESO DE NOTIFICACIÓN DE REACCIONES ADVERSAS A MEDICAMENTOS HACIA UPPSALA MONITORING CENTRE. OMS - UMC"/>
</div>
