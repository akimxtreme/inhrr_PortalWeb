...
<title>Gerencia Sectorial de Registro y Control - Productos Cosméticos (Audiencias)</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
<h1 class="contenedor_0">AUDIENCIAS</h1>

<p class="columns">Las audiencias serán otorgadas cuando el interesado requiera aclaratoria en relación a una inconformidad presentada por el producto en la Evaluación Integral. Serán solicitadas por el Farmacéutico Patrocinante a través del correo electrónico <strong>productoscosméticos@inhrr.gob.ve</strong> indicando:</p>
	<ul class="vinetas">
    	<li class="vinetas">Nombre del producto.</li>
        <li class="vinetas">Número asignado por el INH”RR”.</li>
        <li class="vinetas">Número de Notificación Sanitaria Obligatoria.</li>
        <li class="vinetas">Nombre de la Empresa fabricante, importadora y/o distribuidora.</li>
        <li class="vinetas">Nombre del Farmacéutico Patrocinante.</li>
        <li class="vinetas">Número de COLFAR del Farmacéutico Patrocinante.</li>
        <li class="vinetas">Exposición de motivos.</li>
    </ul>
</div>
