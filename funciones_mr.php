...
<title>Gerencia Sectorial de Producción - División de Producción de Medios y Reactivos (Funciones)</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
<h1 class="contenedor_0">FUNCIONES DE LA DIVISIÓN DE PRODUCCIÓN DE MEDIOS Y REACTIVOS</h1>
<img class="global" src="imagenes/img_gp/gp_20.png" alt="Imagen Gerencia de Producción" title="Imagen Gerencia de Producción">
<ul class="vinetas">
<li class="vinetas">Producir los cultivos celulares, medios de cultivo, reactivos y colorantes, listos para su uso, que son requeridos para el diagnóstico de enfermedades trasmisibles, el control de alimentos, medicamentos, cosméticos, la producción y control de las vacunas, atendiendo la demanda de usuarios internos.</li>
<li class="vinetas">Lavar, acondicionar y suministrar el material de vidrio necesario para el crecimiento y mantenimiento de los cultivos celulares.</li>
</ul>
