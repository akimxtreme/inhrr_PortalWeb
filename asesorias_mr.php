...
<title>Gerencia Sectorial de Producción - División de Producción de Medios y Reactivos (Asesorias)</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
<h1 class="contenedor_0">ASESORIAS</h1>
<ul class="vinetas">
<li class="vinetas">Entrenamientos y/o Pasantías.</li>
</ul>
<img class="global" src="imagenes/img_gp/gp_17.png" alt="Organigrama de la División de Producción de Medios y Reactivos" title="Organigrama de la División de Producción de Medios y Reactivos">
