...
<title>Gerencia Sectorial de Producción - División de Control Interno de Calidad de Biológicos (Visión)</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
<h1 class="contenedor_0">VISIÓN DE LA DIVISIÓN DE CONTROL INTERNO DE CALIDAD DE BIOLÓGICOS</h1>
<p class="boton_global">Ser la División acreditada y certificada, nacional e internacionalmente, con infraestructura, equipos y personal altamente calificado, que garantice la calidad de los productos biológicos elaborados por la Gerencia de Producción del Instituto Nacional de Higiene "Rafael Rangel", para la prevención de enfermedades trasmisibles en la población venezolana.</p>
</div>
<!-- InstanceEndEditable -->
<div class="derecha">
