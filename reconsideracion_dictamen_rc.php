...
<title>Gerencia Sectorial de Registro y Control - Reconsideración a Dictamen</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
<h1 class="contenedor_0">RECONSIDERACIÓN A DICTAMEN</h1>
<p class="boton_global">La solicitud de reconsideración de un dictamen de evaluación o análisis, debe efectuarse en un lapso de tiempo no mayor a  15 días una vez recibido, mediante comunicación dirigida a la Gerencia Sectorial de Registro y Control, anexando los soportes que justifiquen la reconsideración respectiva.</p>
</div>
