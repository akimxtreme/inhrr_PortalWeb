...
a { font-weight:bold;}
a:link { color:#000000; text-decoration: none; background:#FFF; } 
a:visited { color:#000000; text-decoration: none } a:active { color:#FFCC00; text-decoration: none }
...
<table>
<tr><td background="imagenes/fondo1.gif" class="TD2" width="760" height="15">
<?php
include ('cxbdef.php');
