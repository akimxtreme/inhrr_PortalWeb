...
<title>Gerencia Sectorial de Producción - División de Control Interno de Calidad de Biológicos (Organigrama)</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
<h1 class="contenedor_0">ORGANIGRAMA DE LA DIVISIÓN DE CONTROL INTERNO DE CALIDAD DE BIOLÓGICOS</h1>
<img class="centrar" src="imagenes/img_gp/organigrama_ci.png" alt="Organigrama de la División de Control Interno de Calidad de Biológicos" title="Organigrama de la División de Control Interno de Calidad de Biológicos"/>
</div>
<!-- InstanceEndEditable -->
<div class="derecha">
