...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/gerencia_de.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
...
<title>Gerencia Sectorial de Diagnóstico y Vigilancia Epidemiológica - Visión</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
	<h1 class="contenedor_0">VISIÓN DE LA GERENCIA SECTORIAL DE DIAGNÓSTICO Y VIGILANCIA EPIDEMIOLÓGICA</h1>
	<p class="columns2">Ser Centro de Referencia Nacional e Internacional de Diagnóstico y Vigilancia Epidemiológica en enfermedades transmisibles.</p>
    <img class="columns2" src="imagenes/img_de/de_2.png" alt="Gerencia de Diagnóstico y Vigilancia Epidemiológica" />
</div>
<!-- InstanceEndEditable -->
<div class="derecha">
