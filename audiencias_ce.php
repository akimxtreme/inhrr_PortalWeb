...
<title>Gerencia Sectorial de Registro y Control - Centro Nacional de Vigilancia Farmacológica - (Audiencias y Consultas)</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
<h1 class="contenedor_0">AUDIENCIAS Y CONSULTAS</h1>

<p class="boton_global">Deben ser solicitadas mediante correo electrónico a las siguientes direcciones, especificando el tema de la audiencia o consulta y los datos completos del solicitante.</p>
<ul class="vinetas">
<li class="vinetas"><strong>Coordinación Medica:</strong> cenavif@inhrr.gob.ve</li>
<li class="vinetas"><strong>Coordinación Farmacéutica:</strong> cenavicf@inhrr.gob.ve</li>
</ul>
</div>
