...
<?php
include ('cxbdpb.php');
$sql1="SELECT nrs, lote, producto FROM lotes WHERE substr(producto,1,1)='$l' ORDER BY producto ASC";
...
?>
		<li><A href="consulta-1.php?n=<?php echo $num;?>&l=<?php echo $lote;?>" target="contenido1">
		<?php echo $nom,' Lote: ', $lote;?></a></li><br>
<?php
	}
}
?>
