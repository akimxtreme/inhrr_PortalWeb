...
include ('cxbdef.php');
$sql1="SELECT nrs, producto FROM ef_cancelados WHERE publicar = 'S' AND ((nrs LIKE '%".$termbusca."%') OR (producto LIKE '%".$termbusca."%') OR (dci LIKE '%".$termbusca."%')) ORDER BY producto ASC";
