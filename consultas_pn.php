...
<title>Gerencia Sectorial de Registro y Control - Productos Naturales (Consultas)</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
<h1 class="contenedor_0">CONSULTAS</h1>

<p class="boton_global">Las consultas correspondiente a  productos naturales  deberán ser solicitadas  a través del correo electrónico <strong>productosnaturales@inhrr.gob.ve</strong></p>
</div>
