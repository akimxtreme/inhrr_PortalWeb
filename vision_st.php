...
<title>Gerencia Sectorial de Producción - División de Servicios Técnicos Auxiliares (Visión)</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
<h1 class="contenedor_0">VISIÓN DE LA DIVISIÓN DE SERVICIOS TÉCNICOS AUXILIARES</h1>
<p class="boton_global">Generar productos y servicios básicos de alta calidad en concordancia con normas nacionales e internacionales a fin de que las Gerencias productivas, analíticas y diagnósticas del Instituto Nacional de Higiene "Rafael Rangel", provean de bienes y servicios al Ministerio de Salud y Desarrollo Social con el propósito de apoyar sus programas y políticas de resguardo y promoción de la salud pública nacional.</p>
</div>
<!-- InstanceEndEditable -->
<div class="derecha">
