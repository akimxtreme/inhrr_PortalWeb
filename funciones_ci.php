...
<title>Gerencia Sectorial de Producción - División de Control Interno de Calidad de Biológicos (Funciones)</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
<h1 class="contenedor_0">FUNCIONES DE LA DIVISIÓN DE CONTROL INTERNO DE CALIDAD DE BIOLÓGICOS</h1>
<ul class="vinetas">
<li class="vinetas">Controlar la calidad de Materia Prima, Reactivos y Productos para desinfección.</li>
<li class="vinetas">Controlar todos los procesos productivos de las divisiones y departamentos adscritos a la Gerencia Sectorial de Producción.</li>
<li class="vinetas">Controlar la calidad de todos los productos biológicos elaborados en el Instituto Nacional de Higiene "Rafael Rangel" incluyendo las fases de obtención Intermedia, Granel y Final.</li>
</ul>
</div>
<!-- InstanceEndEditable -->
<div class="derecha">
