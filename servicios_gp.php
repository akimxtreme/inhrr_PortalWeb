...
<!-- Contenido -->
<div class="seccion_1">
	<h1 class="contenedor_0">SERVICIOS DE LA GERENCIA SECTORIAL DE PRODUCCIÓN</h1>    
    <ul class="vinetas">
        <li class="vinetas">Lavado, preparación y esterilización de material de laboratorio.</li>
        <li class="vinetas">Descontaminación de material de laboratorio.</li>
        <li class="vinetas">Control de calidad de materia prima, insumos y ambientes.</li>
        <li class="vinetas">Control de calidad de los productos e insumos elaborados.</li>
        <li class="vinetas">Diagnósticos anatomopatológicos en animales y humanos.</li>
        <li class="vinetas">Entrenamiento y asesoría técnica en el área de su competencia a nivel interno, nacional e internacional.</li>
    </ul>
    <img class="columns2" src="imagenes/img_gp/gp_8.png" alt="Imagen Gerencia de Producción" title="Imagen Gerencia de Producción">
	<img class="columns2" src="imagenes/img_gp/gp_7.png" alt="Imagen Gerencia de Producción" title="Imagen Gerencia de Producción">
</div>
<!-- InstanceEndEditable -->
<div class="derecha">
