...
<title>Gerencia Sectorial de Registro y Control - Evaluación de Materiales Médicos</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
<h1 class="contenedor_0">EVALUACIÓN DE MATERIALES MÉDICOS</h1>

<p class="boton_global">Para la evaluación de materiales médicos, con fines de registro, renovación y control sanitario en el Servicio Autónomo de  Contraloría Sanitaria (SACS) del Ministerio del Poder Popular para la Salud, deberá emplear el formulario, según se indica en el instructivo respectivo, anexar los recaudos requeridos y cancelar la tarifa respectiva.</p>
<p class="boton_global">Para la entrega de la solicitud de evaluación deberá solicitar una cita, siguiendo el procedimiento indicado en el vínculo “solicitud de cita para entrega de solicitudes”.</p>
</div>
