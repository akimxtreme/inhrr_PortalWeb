...
<title>Portal Web del Instituto Nacional de Higiene Rafael Rangel - Especialidades Farmacéuticas Aprobadas</title>
...
<div class="seccion_4">
<!--<h1 class="contenedor_0">Especialidades Farmacéuticas Aprobadas</h1>-->
<iframe name="frame" id="miFrame" src="http://190.202.114.146:7474/pa/resultados/index.html" width="100%" height="600" style="border:none; margin:0px; padding:0px;" frameborder="1" transparency="transparency" onload="autofitIframe(this);"></iframe>
