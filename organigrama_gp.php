...
<title>Gerencia Sectorial de Producción (Organigrama)</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
	<h1 class="contenedor_0">ORGANIGRAMA DE LA GERENCIA SECTORIAL DE PRODUCCIÓN</h1>
	<img class="columns" src="imagenes/img_gp/organigrama_gp.png" alt="Organigrama de la Gerencia Sectorial de Producción" title="Organigrama de la Gerencia Sectorial de Producción"/>
</div>
<!-- InstanceEndEditable -->
<div class="derecha">
