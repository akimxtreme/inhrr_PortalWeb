...
<title>Gerencia Sectorial de Registro y Control - Productos Naturales (Denuncias y Reportes de Falla de Calidad)</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
<h1 class="contenedor_0">DENUNCIAS Y REPORTES DE FALLA DE CALIDAD</h1>

<p class="columns">Los ciudadanos en general pueden reportar sus denuncias  y posibles fallas de calidad de los productos naturales comercializados en el país, a través del correo electrónico <strong>productosnaturales@inhrr.gob.ve</strong> o mediante comunicación dirigida al  Instituto Nacional de Higiene “Rafael Rangel y al Servicio Autónomo de Contraloría Sanitaria (SACS).</p>
</div>
