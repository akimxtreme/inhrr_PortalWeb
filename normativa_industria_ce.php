...
<title>Gerencia Sectorial de Registro y Control - Centro Nacional de Vigilancia Farmacológica - (Normativa para la industria: Reporte de Reacciones Adversas)</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
<h1 class="contenedor_0">NORMATIVA INDUSTRIA</h1>

<p class="boton_global">PROXIMAMENTE</p>
</div>
