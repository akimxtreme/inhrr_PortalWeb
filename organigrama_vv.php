...
<title>Gerencia Sectorial de Producción - División de Producción de Vacunas Virales (Organigrama)</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
    <div class="seccion_1">
    	<h1 class="contenedor_0">ORGANIGRAMA DE LA DIVISIÓN DE PRODUCCIÓN DE VACUNAS VIRALES</h1>
    	<img class="columns" src="imagenes/img_gp/organigrama_vv.png" alt="Organigrama de la División de Producción de Vacunas Virales" title="Organigrama de la División de Producción de Vacunas Virales">
    </div>
<!-- InstanceEndEditable -->
<div class="derecha">
