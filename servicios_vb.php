...
<title>Gerencia Sectorial de Producción - División de Vacunas Bacterianas (Servicios)</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
    <h1 class="contenedor_0">PRODUCTOS Y SERVICIOS DE LA DIVISIÓN DE VACUNAS BACTERIANAS</h1>
    <div class="sections70">
        <ul class="vinetas">
            <li class="vinetas">VACUNA DPT (DIFTERIA, PERTUSSIS Y TÉTANOS)</li>
            <li class="vinetas">TOXOIDE TETÁNICO ADSOR81DO</li>
        </ul>
    </div>
    <img class="columns3" src="imagenes/img_gp/gp_12.png" alt="Imagen Gerencia de Producción" title="Imagen Gerencia de Producción">
</div>
<!-- InstanceEndEditable -->
<div class="derecha">
