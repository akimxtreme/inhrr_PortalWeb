...
<title>Planta Productora de Vacunas (Visión) Gerencia Sectorial de Producción</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
    <h1 class="contenedor_0">VISIÓN DE LA PLANTA PRODUCTORA DE VACUNAS</h1>
    <ul class="vinetas">
    	<li class="vinetas">Mantener la autosuficiencia nacional en la producción de vacuna DPT y sus Fracciones (Toxoide Tetánico, Vacunas Pertussis y Toxoide Diftérico).</li>
        <li class="vinetas">Incorporar nuevos antígenos como Hepatitis B (Vacuna tetravalente), Haemophilus lnfluenzae (Vacuna Pentavalente), otros lnmunobiológicos que eventualmente se requieran.</li>
        <li class="vinetas">Exportar excedente de producción.</li>
    </ul>
    <img class="centrar" src="imagenes/img_gp/ppv2.png" alt="Imagen Gerencia de Producción" title="Imagen Gerencia de Producción">
</div>
<!-- InstanceEndEditable -->
<div class="derecha">
