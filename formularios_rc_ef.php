...
<p class="boton_global">Estimular en el participante el trabajo en equipo, conducente a la atención integral del paciente con micosis.</p>-->
   ...
   <td class="global_titulo">Instructivo de llenado</td>
				...
				$urlf2="' target='_blank'><img alt='Adjunto' src='imagenes/img_id/doc_pdf.png' /></a>";
				$urli1="<a href='pdf/rc_pdf/pdf_ef/";
				$urlf4="' title='Instructivo ";
				$urli2="' target='_blank'><img alt='Adjunto' src='imagenes/img_id/doc_pdf.png'/></a>";
			...
			<tr>
				...
				<td class="global_adjunto"><?php echo $urlf1 . $r['adjunto_form'] . $urlf3 . $r['cod_form'] . $urlf2; ?></td>
				<td class="global_adjunto"><?php echo $urlf1 . $r['adjunto_inst'] . $urlf4 . $r['cod_form'] . $urlf2; ?></td>
