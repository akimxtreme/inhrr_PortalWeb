...
<title>Gerencia Sectorial de Producción - División de Producción de Medios y Reactivos (Servicios)</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
<h1 class="contenedor_0">PRODUCTOS Y SERVICIOS QUE BRINDA LA DIVISIÓN DE PRODUCCIÓN DE MEDIOS Y REACTIVOS</h1>
<ul class="vinetas">
<li class="vinetas">Elaboración de Líneas Celulares Derivadas.</li>
<li class="vinetas">Medios de Cultivos, Reactivos y Colorantes, listos para su uso.</li>
</ul>
<img class="global" src="imagenes/img_gp/gp_16.png" alt="Organigrama de la División de Producción de Medios y Reactivos" title="Organigrama de la División de Producción de Medios y Reactivos">
