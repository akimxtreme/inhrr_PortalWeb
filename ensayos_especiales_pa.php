...
<title>Gerencia Sectorial de Registro y Control - Productos Alimenticios (Ensayos Especiales)</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
<h1 class="contenedor_0">ENSAYOS ESPECIALES</h1>

<p class="boton_global">Procedentes de otros organismos del Estado o particulares, deben ser tramitados mediante comunicación dirigida al Presidente del Instituto para su autorización y posterior ingreso en la Unidad de Recepción de Muestras de Alimentos.</p>
</div>
