...
<!-- Contenido -->
<div class="seccion_1">
<h1 class="contenedor_0">MISIÓN DE LA GERENCIA SECTORIAL DE REGISTRO Y CONTROL</h1>
<p class="columns2">Actúa dando cumplimiento a las políticas tanto preventivas como de vigilancia epidemiológica del Ministerio del Poder Popular para la Salud,  mediante el el registro sanitario y vigilancia post-comercialización de los medicamentos, evaluando la calidad de los Productos de Uso y Consumo humano, coadyuvando la formación de recurso humano especializado en el área y realizando investigación básica y aplicada.</p>
<img class="columns2" alt="Gerencia" title="Gerencia" src="imagenes/img_rc/rc_2.png" />
