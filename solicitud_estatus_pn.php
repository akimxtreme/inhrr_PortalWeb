...
<title>Gerencia Sectorial de Registro y Control - Productos Naturales (Solicitud de Estatus)</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
<h1 class="contenedor_0">SOLICITUD DE ESTATUS</h1>

<p class="boton_global">Las solicitudes de estatus de una solicitud correspondiente a  productos naturales  deberán ser solicitadas por el Farmacéutico Patrocinante a través del correo electrónico    <strong>productosnaturales@inhrr.gob.ve</strong> indicando:</p>
<ul class="vinetas">
