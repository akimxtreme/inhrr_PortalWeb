...
<title>Gerencia Sectorial de Producción - División de Producción de Medios y Reactivos (Visión)</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
<h1 class="contenedor_0">VISIÓN DE LA DIVISIÓN DE PRODUCCIÓN DE MEDIOS Y REACTIVOS</h1>
<p class="boton_global">Ser un ente certificado y acreditado como productor de cultivos celulares, medios de cultivo, reactivos y colorantes, listos para su uso, empleados en el diagnóstico de enfermedades transmisibles e investigaciones microbiológicas, con garantía de su calidad y disponibilidad en el momento que sean requeridos.</p>
<img class="global" src="imagenes/img_gp/gp_15.png" alt="Imagen Gerencia de Producción" title="Imagen Gerencia de Producción">
</div>
<!-- InstanceEndEditable -->
<div class="derecha">
