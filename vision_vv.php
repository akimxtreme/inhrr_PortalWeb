...
<title>Gerencia Sectorial de Producción - División de Producción de Vacunas Virales (Visión)</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
    <div class="seccion_1">
    	<h1 class="contenedor_0">VISIÓN DE LA DIVISIÓN DE PRODUCCIÓN DE VACUNAS VIRALES</h1>
        <div class="sections2">
    		<p class="columns">Sustituir la Tecnología de Producción de la Vacuna Antirrábica Humana actual por la de Cultivo Celular, siguiendo los dictámenes de los entes regulatorios Nacionales e Internacionales en la materia.</p>
    		<p class="columns">Poseer una infraestructura adaptada a la normativa actual que permita ampliar la producción de inmune-biológicos de origen viral según las necesidades prioritarias del
    país.</p>
    	</div>
    	<img class="columns2" src="imagenes/img_gp/gp_6.png" alt="Imagen Gerencia de Producción" title="Imagen Gerencia de Producción">
    </div>
<!-- InstanceEndEditable -->
<div class="derecha">
