...
<title>Gerencia Sectorial de Registro y Control - Productos Evaluados</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
<h1 class="contenedor_0">PRODUCTOS EVALUADOS</h1>
<ul class="vinetas">
<li class="vinetas">Alimentos.</li>
<li class="vinetas">Cosméticos.</li>
<li class="vinetas">Especialidades Farmacéuticas.</li>
<li class="vinetas">Productos Naturales.</li>
<li class="vinetas">Productos Biológicos.</li>
<li class="vinetas">Vacunas.</li>
<li class="vinetas">Materiales Médicos y Estuches Biológicos para  Diagnóstico.
</li>
</ul>
</div>
