...
<title>Gerencia Sectorial de Producción - División de Vacunas Bacterianas (Organigrama)</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
	<h1 class="contenedor_0">ORGANIGRAMA DE LA DIVISIÓN DE VACUNAS BACTERIANAS</h1>
	<img class="columns" src="imagenes/img_gp/organigrama_vb.png" alt="Organigrama de la División de Vacunas Bacterianas" title="Organigrama de la División de Vacunas Bacterianas"/>
</div>
<!-- InstanceEndEditable -->
<div class="derecha">
