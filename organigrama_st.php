...
<title>Gerencia Sectorial de Producción - División de Servicios Técnicos Auxiliares (Organigrama)</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
<div class="seccion_1">
<h1 class="contenedor_0">ORGANIGRAMA DE LA DIVISIÓN DE SERVICIOS TÉCNICOS AUXILIARES</h1>
<img class="centrar" src="imagenes/img_gp/organigrama_st.png" alt="Organigrama de la División de Servicios Técnicos Auxiliares" title="Organigrama de la División de Servicios Técnicos Auxiliares"/>
</div>
<!-- InstanceEndEditable -->
<div class="derecha">
