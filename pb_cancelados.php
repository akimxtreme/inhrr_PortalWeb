...
<title>Portal Web del Instituto Nacional de Higiene Rafael Rangel - Productos Biológicos Cancelados</title>
...
<div class="seccion_4">
<h1 class="contenedor_0">Productos Biológicos Cancelados</h1>
<iframe name="frame" id="miFrame" src="http://190.202.114.146:7474/pb/cancelados_pb/" width="100%" height="600" style="border:none; margin:0px; padding:0px;" frameborder="1" transparency="transparency" onload="autofitIframe(this);"></iframe>

<!--<iframe name="frame" id="miFrame" src="cancelados_pb/index2.php" width="100%" height="0" style="border:none; margin:0px; padding:0px;" frameborder="1" transparency="transparency" onload="autofitIframe(this);"></iframe>-->
