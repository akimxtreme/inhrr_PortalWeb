...
<title>Gerencia Sectorial de Producción - División de Producción de Medios y Reactivos (Misión)</title>
<!-- InstanceEndEditable -->
...
<!-- Contenido -->
    <div class="seccion_1">
    	<h1 class="contenedor_0">MISIÓN DE LA DIVISIÓN DE PRODUCCIÓN DE MEDIOS Y REACTIVOS</h1>
        <img class="columns2" src="imagenes/img_gp/gp_14.png" alt="Imagen Gerencia de Producción" title="Imagen Gerencia de Producción">
    	<p class="columns2">La División de Producción de Medios y Reactivos, adscrita a la Gerencia Sectorial de Producción de Biológicos del Instituto Nacional de Higiene "Rafael Rangel" es la responsable de la producción de Cultivos Celulares, Medios de Cultivos , Reactivos y Colorantes listos para su uso, empleados en el diagnóstico de enfermedades transmisibles, control e Investigaciones microbiológicas en alimentos, medicamentos, cosméticos y producción de biológicos, atendiendo los requerimientos de usuarios internos y externos.</p>
    </div>
<!-- InstanceEndEditable -->
<div class="derecha">
